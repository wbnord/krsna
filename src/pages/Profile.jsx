...
export default function Profile() {
  ...
  return (
    <>
    <section className="max-w 6*l mx-auto flex justify-center
    items-center flex-col">
      <h1 className="text-3*l text-center mt-6 font-bold">
         My Profile
      </h1>
      <div className="w-full md:w-[50%] mt-6 px-3">
        <form>
          ...
          disabled className="mb-6 w-full px-4 text-xl text-gray-700
