...
export default function EditListing()
{
    ...
    async function onSubmit(e){
      ...
      if (images.length > 6){
        setLoading(false);
        toast.error("maximum 6 pages are allowed");
        return;
      }
      let geolocation={}
      let location
      if(geolocationEnabled){
            const response =await fetch(`https://api.distancematrix.ai/maps/api/geocode/json?address=1600+Amphitheatre+Parkway,+Mountain+View,+CA&key=kD53UDpsK2HDmQj0ftjH3HTvAd00RKfERGNCAxJZl6jaAQRkKOFDE17EVOEzg5PV&key=${
