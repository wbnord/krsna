...
export default function CreatingListing() {
  ...
  return (
    <main className="max-w-md px-2 mx-auto">
        <h1 className="text-3*l text-center
        mt-6 font-bold">Creating a Listing</h1>
        <form>
        ...
        <p className="text-lg mt-6 font-semibold">Address</p>
                ...
                {onChange} placeholder="Address" 
                 required className="w-full px4 py-2
                text-xl text-gray-700 bg-white border-gray-300
                rounded transition duration-150 ease-in-out 
                focus:text-gray-700 focus:bg-white focus:border-slate-600
                mb-6"/>
        ...
        <div className="flex mb-6">
          ...
          <div className="mb-6">
                ...
                <input type="file" id="images" onChange={onChange}
                   accept=".jpg,.png,.jpeg"
                   multiple required className="w-full px-3 py-1.5 text-gray-700
