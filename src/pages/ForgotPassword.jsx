...
export default function ForgotPassword() {
  ...
  return (
      <section>
        <h1 className="text -3*1 text-center mt-6 font-bold">Forgot Password</h1>
        <div>
          <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6*l mx-auto" />
          <div className="md:w-[67%] lg:w-[50%] mb-12 md:md:6">
            ...
            <div className="w-full md;w-[67%] lg:w-[40%] lg:ml-20">
              ...
              type="submit">Set reset password
              </button>
